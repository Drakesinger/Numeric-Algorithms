...
TwoNodes::TwoNodes(const OneNode& upper, const OneNode& lower,
                               double dt, double g) :
...
void TwoNodes::update(double newTime)
{
...
void TwoNodes::derivate(const double *yin, double *dydx)
{
    // Delta is θ2 - θ1
    ...
    // Multiply den by the length ratio of the two nodes
    den *= m_l2 / m_l1;
